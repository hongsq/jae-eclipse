...
import com.jae.eclipse.navigator.jaeapp.action.AbstractJDAction;
...
public class JDappCodeImportAction extends AbstractJDAction implements IPageChangedListener {

	public JDappCodeImportAction(ISelectionProvider provider, String text) {
		super(provider, text);
